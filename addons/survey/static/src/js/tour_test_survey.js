...
tour.register('test_survey', {
    ...
    [
        ...
        {
            content: "For 'I use the contextual help in Byte  ERP' checking 'Agree'",
        ...
        // Question: What do you think about the process views of Byte  ERP, available in the web client ?
        {
            content: "For 'They help new users to understand Byte  ERP' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to Byte  ERP?
        {
