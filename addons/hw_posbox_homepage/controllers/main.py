...
""" + index_style + """
    ...
    <body>
        ...
        receipt printers and barcode scanners with Byte  ERP's Point of
        ...
        the posbox version number is independent from Byte  ERP. You can upgrade
        the software on the <a href='/hw_proxy/upgrade/'>upgrade page</a>.
        </p>
        <p>For any other question, please contact the Byte  ERP support at <a href='mailto:help@odoo.com'>help@odoo.com</a>
        </p>
    </body>
</html>
...
<p>
    ...
    You can find the latest images on the <a href="http://nightly.odoo.com/master/posbox/">Byte  ERP Nightly builds</a> website.
    Make sure to download at least the version 16.<br/>
    Byte  ERP version 11, or above, is required to use the customer display feature.
</p>
"""
