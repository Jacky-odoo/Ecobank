...
class HrPayslipRun(models.Model):
    ...
    def check_date_start_date_end(self):
        for rec in self:
            if rec.date_start > rec.date_end:
                raise fields.UserError("Date Start cannot be greater  than date end")
...
class HrPayslip(models.Model):
    ...
    def compute_sheet(self):
        ...
        for payslip in self:
            ...
            _logger.info("completed "+str(len(done))+" Remaining "+str(len(self)-len(done)))
