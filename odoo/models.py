...
class BaseModel(object):
    """ Base class for Byte  ERP models.

    Byte  ERP models are created by inheriting:
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted Byte  ERP models.

    Byte  ERP models are created by inheriting from this class::
