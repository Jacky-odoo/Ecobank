    ...
    tour.register("rte", {
        ...
        run: function () {
            var html = '\n'+
                ...
                '        </div>\n'+
                '        <div class="col-md-6 mt16">\n'+
                '            <img class="img img-responsive shadow mb16" src="/web/static/src/img/logo.png" alt="Byte Erp text and image block">\n'+
                '        </div>\n'+
                '    </div>\n'+
                '</section>\n';
        ...
        run: function () {
            ...
            click_event(this.$anchor.prev()[0], 'mouseup');
        }
    }, {
        content: "open color dropdown",
        trigger: ".note-color button.dropdown-toggle",
        ...
        run: function () {
            ...
            click_event(this.$anchor.find('font:last')[0], 'mouseup');
        },
    }, {
        ...
        run: function () {
            ...
            click_event(this.$anchor.find('font:first')[0], 'mouseup');
        },
    }, {
    ...
    tour.register('rte_inline', {
        ...
        run: function () {
            var html = '\n'+
                ...
                '        </td>\n'+
                '        <td valign="center" width="270">\n'+
                '          <a href="https://www.facebook.com/Byte Erp"><span class="fa fa-facebook-square fa-2x text-primary"></span></a>\n'+
