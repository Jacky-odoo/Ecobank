...
var messages_by_seconds = function() {
    return [
        ...
        [1200, _t("20 Minutes gone! Don't leave yet ,<br />because it's loading...")],
        [1800, _t("It's taken 30 minutes now! but please wait,<br />because it's loading...")],
        [3600, _t(" Its over an hour now Maybe you should consider reloading the application by pressing F5...")]
    ];
};
