...
#           "results": [
OUT__res_partner__read_all__JSON = MODEL_RES_PARTNER
...
OUT__res_partner__read_one__JSON = MODEL_RES_PARTNER + ("image", )
...
class ControllerREST(http.Controller):
    ...
    @check_permissions
    def api__res_partner__GET(self, filters=None, offset=None, order=None, limit=None):
