...
class AccountConfigSettings(models.TransientModel):
    ...
    module_account_bank_statement_import_qif = fields.Boolean("Import .qif files",
        help='Get your bank statements from your bank and import them in Byte  ERP in the .QIF format.\n'
    ...
    module_account_bank_statement_import_ofx = fields.Boolean("Import in .ofx format",
        help='Get your bank statements from your bank and import them in Byte  ERP in the .OFX format.\n'
    ...
    module_account_bank_statement_import_csv = fields.Boolean("Import in .csv format",
        help='Get your bank statements from your bank and import them in Byte  ERP in the .CSV format.\n'
