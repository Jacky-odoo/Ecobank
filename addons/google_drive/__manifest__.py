...

{
    ...
    'description': """
Integrate google document to Byte  ERP record.
============================================

This module allows you to integrate google documents to any of your Byte  ERP record quickly and easily using OAuth 2.0 for Installed Applications,
