...
class pos_order(models.Model):
    ...
    def _check_hash_integrity(self, company_id):
        ...
        raise UserError(_('''Successful test !
                         ...
                         For this report to be legally meaningful, please download your certification from your customer account on Byte  ERP.com (Only for Byte  ERP Enterprise users).'''
                         ) % report_dict)
