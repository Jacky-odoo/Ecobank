...
# here to init the T1 fonts cache at the start-up of Byte  ERP so that rendering of barcode in multiple
...
#--------------------------------------------------------------------------
# Check the presence of Wkhtmltopdf and return its version at Byte  ERP start-up
#--------------------------------------------------------------------------
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start Byte  ERP with at least two workers to print a pdf version of the reports.')
